...
async function checkStatus(){
  try{
    ...
    $('connection').textContent='SellerChamp connected'; if($('appVersion')) $('appVersion').textContent='v'+(data.version||'2.19.0'); $('connection').className='status ok'; $('pinCard').classList.add('hidden');
  }catch(e){
