...
async function checkStatus(){
  try{
    ...
    $('connection').textContent='SellerChamp connected'; if($('appVersion')) $('appVersion').textContent='v'+(data.version||'2.26.0'); $('connection').className='status ok'; $('pinCard').classList.add('hidden');
  }catch(e){
